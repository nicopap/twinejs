...
function domToObject(storyEl, forceLastUpdate, author, expiry) {
	return {
		/*
...
module.exports = (html, lastUpdate, author, expiry) => {
	...
	.map(storyEl => domToObject(storyEl, lastUpdate, author, expiry));
};
